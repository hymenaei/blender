...
SAMPLER(1, sampler1D, propedit_ramp_tx)
PUSH_CONSTANT(bool, use_prop_visualize)
PUSH_CONSTANT(float3, prop_center)
PUSH_CONSTANT(float, prop_size)
PUSH_CONSTANT(int, prop_mode)
